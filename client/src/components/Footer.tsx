      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 dark:text-gray-600">
              <li className="hover:text-white dark:hover:text-black transition-colors cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 dark:text-gray-600">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>trade@cliftontraders.com</span>
              </li>
            </ul>
            
            {/* Social Media */}
            <div className="mt-6">
              <h5 className="font-medium mb-3 text-white dark:text-black">Follow Us</h5>
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-8 h-8 bg-blue-800 hover:bg-blue-900 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-8 h-8 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
