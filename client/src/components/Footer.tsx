...
export function Footer() {
  ...
  return (
    <footer className="dark:bg-white text-white dark:text-black py-12 bg-[#0d0d0ded]">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-8 h-8 bg-gray-600 hover:bg-gray-500 dark:bg-gray-300 dark:hover:bg-gray-400 rounded-full flex items-center justify-center transition-colors">
