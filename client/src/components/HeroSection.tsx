        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mt-[50px]">
            ...
            <div className="relative">
              <p className="text-lg sm:text-xl lg:text-2xl mb-10 text-gray-900 dark:text-gray-300 animate-fade-up animation-delay-1500 max-w-4xl mx-auto leading-relaxed font-medium text-stroke">
