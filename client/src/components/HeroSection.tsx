        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mt-[50px]">
            ...
            <div className="mb-8 text-center">
              <div className="flex items-center justify-center gap-3 flex-wrap animate-fade-up animation-delay-300">
                <div className="flex items-center gap-2">
                  <span className="sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-100 text-[34px]">CLIFTON</span>
                ...
                <div className="flex items-center gap-2 relative z-10">
                  <span className="sm:text-2xl lg:text-3xl font-semibold text-gray-900 dark:text-gray-200 text-[30px]">Import</span>
            ...
            <div className="relative">
              <p className="text-lg sm:text-xl lg:text-2xl mb-10 dark:text-gray-300 animate-fade-up animation-delay-1500 max-w-4xl mx-auto leading-relaxed font-semibold text-[#111827] text-shadow-white">
